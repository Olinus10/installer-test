...
const DEFAULT_UNIVERSAL_URL: &str = "https://cdn.jsdelivr.net/gh/Wynncraft-Overhaul/majestic-overhaul@master/universal.json";
const DEFAULT_PRESETS_URL: &str = "https://cdn.jsdelivr.net/gh/Wynncraft-Overhaul/majestic-overhaul@master/presets.json";
const DEFAULT_CHANGELOG_URL: &str = "https://cdn.jsdelivr.net/gh/Wynncraft-Overhaul/majestic-overhaul@master/changelog.json";
