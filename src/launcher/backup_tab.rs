use dioxus::prelude::*;
use crate::installation::{Installation, BackupConfig, BackupType, BackupMetadata, BackupProgress, RollbackManager, RollbackOption};
        ...
        div { class: "backup-tab",
            ...
            div { class: "backup-section create-backup",
                ...
                div { class: "backup-size-estimate",
                    "Estimated size: {crate::installation::format_bytes(*estimated_size.read())}"
                }
    ...
    rsx! {
        div { class: "backup-progress",
            ...
            div { class: "progress-details",
                ...
                div { "Size: {crate::installation::format_bytes(progress.bytes_processed)}/{crate::installation::format_bytes(progress.total_bytes)}" }
            }
        }
    }
}
            ...
            div { class: "modal-container backup-config-dialog",
                ...
                div { class: "modal-content",
                    ...
                    div { class: "estimated-size",
                        "Estimated backup size: {crate::installation::format_bytes(estimated_size)}"
                    }
                }
    ...
    rsx! {
        div { 
            ...
            div { class: "option-details",
                ...
                span { "Size: {crate::installation::format_bytes(option.size)}" }
            }
